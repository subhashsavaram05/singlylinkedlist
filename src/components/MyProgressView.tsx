...
export const MyProgressView: React.FC<MyProgressViewProps> = ({ onNavigateToTab }) => {
  ...
  const renderStatusBadge = (status: ModuleStatus) => {
    switch (status) {
      ...
      case 'IN_PROGRESS':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 text-xs font-semibold rounded-full bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-900/30">
      ...
      default:
        return (
          <span className="inline-flex items-center gap-1 px-2.5 py-0.5 text-xs font-medium rounded-full bg-slate-50 dark:bg-[#080D1F] text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-blue-900/20">
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 font-sans text-slate-900 dark:text-white animate-page-enter pb-24">
      {/* Header Section */}
      <div className="border-b border-slate-200 dark:border-blue-900/30 pb-6 mb-8">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-2">
          <div className="flex items-center gap-3">
            <span className="text-xs font-bold font-mono uppercase tracking-widest text-blue-600 dark:text-blue-300 bg-blue-50 dark:bg-blue-950/60 px-2.5 py-1 rounded-md border border-blue-100 dark:border-blue-900/30">
        ...
        {is100Percent && (
          <div
            ...
            className="mt-6 p-5 bg-gradient-to-r from-blue-50 to-blue-100/60 dark:from-blue-950/50 dark:to-slate-900 border border-blue-200 dark:border-blue-900/30 rounded-2xl shadow-xs dark:shadow-[0_0_20px_rgba(37,99,235,0.25)] flex flex-col sm:flex-row items-center justify-between gap-4 animate-editorial-scale"
          >
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="text-xs font-bold font-mono text-blue-700 dark:text-blue-300 uppercase tracking-wider">
                  ★ Congratulations! 100% Curriculum Completed
                </div>
                <div className="text-base sm:text-lg font-extrabold text-slate-900 dark:text-white">
                  You Have Mastered All {stats.theory.total} Concepts & Activities
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-blue-900/30 rounded-2xl p-6 shadow-xs dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] relative overflow-hidden reveal-on-scroll">
        ...
        <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-blue-900/30 rounded-2xl p-6 flex flex-col justify-between shadow-xs dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] reveal-on-scroll stagger-1">
          <div className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-2">
            Performance Stats
          </div>

          <div className="grid grid-cols-3 gap-2 py-3 border-y border-slate-100 dark:border-blue-900/25 text-center">
            <div>
            ...
            <div className="border-x border-slate-100 dark:border-blue-900/25">
            ...
            <div>
              <div className="text-2xl font-extrabold text-blue-600 dark:text-blue-400 font-mono">{progressState.levelsCompleted.length} / 5</div>
          ...
          <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 mt-3 font-medium">
            <Trophy className="w-4 h-4 text-blue-600 dark:text-blue-400 shrink-0" />
        ...
        <div className="bg-gradient-to-br from-blue-50/60 to-white dark:from-blue-950/40 dark:to-[#0B1228] border border-blue-100 dark:border-blue-900/30 rounded-2xl p-6 flex flex-col justify-between shadow-xs dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] reveal-on-scroll stagger-2">
          <div>
            <div className="flex items-center justify-between text-xs font-bold font-mono uppercase tracking-wider text-blue-600 dark:text-blue-300 mb-1">
      ...
      <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-blue-900/30 rounded-2xl p-5 mb-8 shadow-xs dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] reveal-on-scroll">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-900/30">
      ...
      {/* Filter Tabs */}
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 dark:border-blue-900/30 pb-3 mb-6">
          ...
          {(['ALL', 'FOUNDATION', 'TECHNIQUE', 'ANALYSIS', 'EXAMINATION'] as const).map((cat) => (
            <button
              ...
              className={`px-3.5 py-1.5 text-xs font-semibold rounded-lg transition-all cursor-pointer ${activeFilter === cat
                ? 'bg-blue-600 text-white shadow-xs dark:shadow-[0_0_10px_rgba(37,99,235,0.4)]'
          ...
          return (
            <div
              ...
              className={`bg-white dark:bg-[#0B1228] border rounded-2xl p-5 sm:p-6 transition-all duration-200 shadow-xs dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] reveal-on-scroll ${staggerClass} ${isDone
                ? 'border-slate-200 dark:border-blue-900/30 hover:border-slate-300 dark:hover:border-blue-800'
                : isInProgress
                  ? 'border-blue-400 dark:border-blue-500/60 ring-1 ring-blue-200 dark:ring-blue-500/30'
                  : 'border-slate-200 dark:border-blue-900/30 hover:border-slate-300 dark:hover:border-blue-800'
                }`}
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="text-xs font-bold font-mono px-2 py-0.5 bg-slate-100 dark:bg-[#080D1F] border border-slate-200 dark:border-blue-900/30 text-slate-700 dark:text-slate-300 rounded-md">
                      {m.code}
                    </span>
                    <span className="text-xs font-semibold text-blue-600 dark:text-blue-400 uppercase font-mono">
                      {m.category}
                    </span>
                  ...
                  <div className="mt-3 flex items-center gap-2 text-xs text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-[#080D1F] px-3 py-1.5 rounded-lg border border-slate-200/80 dark:border-blue-900/30 inline-block font-sans">
                ...
                <div className="flex flex-col sm:items-end justify-between gap-3 shrink-0 sm:border-l sm:border-slate-100 dark:sm:border-blue-900/25 sm:pl-6">
